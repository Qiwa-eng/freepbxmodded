...
<?php } ?>
<?php
$loginBrand = htmlspecialchars(!empty($amp_conf['DASHBOARD_FREEPBX_BRAND']) ? $amp_conf['DASHBOARD_FREEPBX_BRAND'] : $amp_conf['BRAND_TITLE'], ENT_QUOTES, 'UTF-8');
?>
<div id="login_form">
	<form id="loginform" method="post" role="form">
		<h3><?php echo sprintf(_('Sign in to %s'), $loginBrand); ?></h3>
...
<div id="login_icon_holder">
	<div class="login_item_title">
		...
		<span class="login_item_text" style="display: block;width: 160px;text-align: center;">
			<?php echo str_replace('FreePBX', $loginBrand, _('FreePBX Administration')); ?>
		</span>
	</div>
	<div class="login_item_title">
