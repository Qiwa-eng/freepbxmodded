...
global $amp_conf;
global $_item_sort;
$citadelBrandTitle = htmlspecialchars($amp_conf['BRAND_TITLE'], ENT_QUOTES, 'UTF-8');
$citadelBrandLabel = htmlspecialchars($amp_conf['DASHBOARD_FREEPBX_BRAND'], ENT_QUOTES, 'UTF-8');
?>
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand citadel-navbar-brand" href="#" data-brand-label="<?php echo $citadelBrandLabel; ?>" title="<?php echo $citadelBrandTitle; ?>">
				...
				<span class="citadel-brand-wordmark"><?php echo $citadelBrandLabel; ?></span>
				</a>
			</div>
