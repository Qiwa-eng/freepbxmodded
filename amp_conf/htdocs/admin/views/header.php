...
$citadelBrandDefaults = array(
    'BRAND_TITLE' => 'Citadel GSM Control',
    'DASHBOARD_FREEPBX_BRAND' => 'Citadel GSM',
    'BRAND_FREEPBX_ALT_LEFT' => 'Citadel GSM',
    'BRAND_FREEPBX_ALT_FOOT' => 'Citadel GSM',
    'BRAND_SPONSOR_ALT_FOOT' => 'Citadel GSM',
    'BRAND_IMAGE_TANGO_LEFT' => 'assets/images/citadel-logo.svg',
    'BRAND_IMAGE_FREEPBX_FOOT' => 'assets/images/citadel-logo.svg',
    'BRAND_IMAGE_SPONSOR_FOOT' => 'assets/images/citadel-logomark.svg',
    'BRAND_IMAGE_FAVICON' => 'assets/images/citadel-favicon.svg',
    'BRAND_IMAGE_FREEPBX_LINK_LEFT' => 'https://citadelgsm.io',
    'BRAND_IMAGE_FREEPBX_LINK_FOOT' => 'https://citadelgsm.io',
    'BRAND_IMAGE_SPONSOR_LINK_FOOT' => 'https://citadelgsm.io'
);
foreach ($citadelBrandDefaults as $key => $value) {
    if (!isset($amp_conf[$key]) || trim((string)$amp_conf[$key]) === '' || stripos((string)$amp_conf[$key], 'freepbx') !== false || stripos((string)$amp_conf[$key], 'sangoma') !== false) {
        $amp_conf[$key] = $value;
    }
}

$citadelBrandTitleEscaped = htmlspecialchars($amp_conf['BRAND_TITLE'], ENT_QUOTES, 'UTF-8');
$citadelBrandLabelEscaped = htmlspecialchars($amp_conf['DASHBOARD_FREEPBX_BRAND'], ENT_QUOTES, 'UTF-8');
$citadelBrandLogoEscaped = htmlspecialchars($amp_conf['BRAND_IMAGE_TANGO_LEFT'], ENT_QUOTES, 'UTF-8');
$citadelBrandAltEscaped = htmlspecialchars($amp_conf['BRAND_FREEPBX_ALT_LEFT'], ENT_QUOTES, 'UTF-8');
$citadelBrandLinkEscaped = htmlspecialchars($amp_conf['BRAND_IMAGE_FREEPBX_LINK_LEFT'], ENT_QUOTES, 'UTF-8');
$citadelBrandTaglineEscaped = htmlspecialchars('Adaptive network orchestration', ENT_QUOTES, 'UTF-8');
...
$html .= '<link href="assets/css/modern-theme.css'.$version_tag.'" rel="stylesheet" type="text/css">';
...
$html .= '<script type="text/javascript" src="assets/js/citadel-theme.js' . $version_tag . '"></script>';
...
//open body
$html .= '<body class="citadel-theme">';

$html .= '

$html .= '<div id="citadel-loader" class="citadel-loader citadel-loader-active" role="status" aria-live="polite">';
$html .= '<div class="citadel-loader__core" data-brand-link="' . $citadelBrandLinkEscaped . '">';
$html .= '<div class="citadel-loader__halo"></div>';
$html .= '<div class="citadel-loader__orbit"></div>';
$html .= '<img src="' . $citadelBrandLogoEscaped . '" alt="' . $citadelBrandAltEscaped . '" class="citadel-loader__logo" />';
$html .= '<span class="citadel-loader__wordmark">' . $citadelBrandLabelEscaped . '</span>';
$html .= '<span class="citadel-loader__tagline">' . $citadelBrandTaglineEscaped . '</span>';
$html .= '<div class="citadel-loader__spinner" aria-hidden="true"></div>';
$html .= '</div>';
$html .= '</div>';
